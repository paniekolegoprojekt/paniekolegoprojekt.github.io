...
export const projects: ProjectProps[] = [
  {
    ...
    shortDesc: "branding, www, konfiguracja skrzynek mailowych",
    date: "2023.09",
  ...
  },
  {
    ...
    date: "2024.02",
    description:
      "identyfikacja wizualna dla agencji marketingowej / biuro kreacji projektów dotacyjnych, specjalizującej się w biznesie i sporcie, marketing 360° ",
...

  {
    ...
    description:
      "<p>identyfikacja wizualna dla firmy specjalizującej się w technologii Paintless Dent Repair</p><p>- naming - czyli proces tworzenia nazwy marki</p>",
    assets: [
...

  {
    ...
    assets: [
      ...
      "https://www.youtube.com/watch?v=yNHWXxynUvs",
    ],
  ...
  },
  {
    ...
    <p>namalowane na terenie miejscowości Bralin,</p> <p>graffiti,
    </p> strona www <a class="underline" href='https://www.szablonylokalne.pl'>www.szablonylokalne.pl</a>`,
